...
from ur_reinforcement_learning.env.robot_gazebo_env_goal import RobotGazeboEnv 

# UR5 Utils
from ur_reinforcement_learning.env.ur_setups import setups
from ur_reinforcement_learning.env import ur_utils
...
reg = gym.envs.register(
    id='URSimEnv-v0',
    entry_point='ur_reinforcement_learning.env:URSimEnv', 
    #timestep_limit=100000,
    )

class URSimEnv(robot_gazebo_env_goal.RobotGazeboEnv):
    def __init__(self):
    	rospy.logdebug("Starting URSimEnv Class object...")
