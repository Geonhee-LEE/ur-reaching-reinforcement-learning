...
reg = gym.envs.register(
    id='UR-v0',
    entry_point='ur_training.env.ur_env:UREnv', # Its directory associated with importing in other sources like from 'ur_training.env.ur_env import *' 
